function show_login() {
    window.location.href = "http://localhost/cifrado_asimetrico/views/login.php";
}


function crear_llave_privada() {
    window.location.href = "http://localhost/cifrado_asimetrico/models/crear_llave_priv.php";
}


function show_mensaje(este) {
    var id_mensaje = $(este).data('id_mens');
    window.location.href = 'http://localhost/cifrado_asimetrico/views/ver_mensaje.php?id=' + id_mensaje;
}
...
function descifrar_mens(mensaje) {
    ...
    if (window.File && window.FileReader && window.FileList && window.Blob) {
        ...
        reader.addEventListener('load', function() {
            ...
            $.ajax({
                url: 'http://localhost/cifrado_asimetrico/models/descifrar_mensaje.php',
...
function show_registrar() {
    window.location.href = "http://localhost/cifrado_asimetrico/views/registrar.php";
...
function cambio_habit() {
    ...
    if (tipo_habit == 'Selecciona') {
        ...
        $.ajax({
            url: 'http://localhost/cifrado_asimetrico/models/validar_habitacion.php',
...
function fin_reservacion() {
    ...
    $.ajax({
        url: 'http://localhost/cifrado_asimetrico/models/fin_reservacion.php',
...
function descifrar() {
    ...
    $.ajax({
        url: 'http://localhost/cifrado_asimetrico/models/mostrar_datos_bancarios.php',
